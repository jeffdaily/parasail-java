...
{{
    ...
    result = parasail_{0}{1}{2}{3}(c_s1, s1Len, c_s2, s2Len, open, gap, c_matrix);
...
{{
    ...
    result = parasail_{0}{1}{2}{3}{4}(c_s1, s1Len, c_s2, s2Len, open, gap, c_matrix);
...
{{
    ...
    result = parasail_{0}{1}{2}{3}{4}(c_profile, c_s2, s2Len, open, gap);
